        ...
        '<tr class="tr-shadow">'+
                ...
                '<td>'+
                    '<div class="row _'+counter+'">'+
                        '<div class="col-sm-3 padding-2 img1 align-center">'+
                            '<span class="outer"><input type="file" class="display-none image-upload1" name="img'+counter+''+counter+'" accept=".jpg,.jpeg,.png" required>'+
				...
				"<img class=\"" + x1 + "\" src=\"\"/> <br/>" +
                        ...
                        '<div class="col-sm-3 padding-2 img2 align-center">'+
                            '<span class="outer"><input type="file" class="display-none image-upload2" name="img'+counter+''+counter+'" accept=".jpg,.jpeg,.png">'+
				...
				"<img class=\"" + x2 + "\" src=\"\"/> <br/>" +
                        ...
                        '<div class="col-sm-3 padding-2 img3 align-center">'+
                            '<span class="outer"><input type="file" class="display-none image-upload3" name="img'+counter+''+counter+'" accept=".jpg,.jpeg,.png">'+
				...
				"<img class=\"" + x3 + "\" src=\"\"/> <br/>" +
                        ...
                        '<div class="col-sm-3 padding-2 img4 align-center">'+
                            '<span class="outer"><input type="file" class="display-none image-upload4" name="img'+counter+''+counter+'" accept=".jpg,.jpeg,.png">'+
